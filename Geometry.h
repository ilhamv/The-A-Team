...
// Region base class
class Region_t : public Geometry_t
{
	private:
	...
	public:
     		 Region_t( const std::string n, const double imp ) : // Pass name and importance
		...
		virtual void collision( Particle_t& P, std::stack< Particle_t >& Pbank, std::vector<double> evChi, std::vector<double>cdfChi );
};
